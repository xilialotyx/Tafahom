# Generated by Django 4.1.9 on 2023-05-17 07:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('values', models.CharField(blank=True, max_length=255, null=True, verbose_name='مقدار')),
            ],
            options={
                'verbose_name': 'آپشن',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('law_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='tafahom.law', verbose_name='قانون')),
                ('miz_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='tafahom.miz', verbose_name='میز کار')),
                ('organization_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='tafahom.organization', verbose_name=' سازمان')),
                ('retern_type_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='tafahom.reterntype', verbose_name='نحوه باز پرداخت')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mablagh', models.DecimalField(decimal_places=0, help_text='مبلغ', max_digits=12, verbose_name='مبلغ')),
                ('modat', models.IntegerField(blank=True, help_text='مدت', null=True, verbose_name='مدت')),
                ('res_type_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='tafahom.restype', verbose_name='نوع منبع')),
                ('tafahom_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='tafahom.tafahom', verbose_name='تفاهم نامه')),
            ],
            options={
                'verbose_name': 'وام',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('res_type_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='tafahom.restype', verbose_name='نوع منبع')),
                ('tafahom_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='tafahom.tafahom', verbose_name='تفاهم نامه')),
            ],
            options={
