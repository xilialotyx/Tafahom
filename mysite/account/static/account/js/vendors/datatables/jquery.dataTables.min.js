...
(function (Ea, P, k) {
    var O = function (h) {
        ...
        function y(a, b, c, e) {
            var d = a.iDraw, f = a.aoColumns[c], g = a.aoData[b]._aData, i = f.sDefaultContent,
        ...
        function na(a, b, c, e) {
            var d = [], f = b.firstChild, g, i = 0, j, n = a.aoColumns, l = a._rowReadObject, e = e || l ? {} : [],
                q = function (a, b) {
                    if ("string" === typeof a) {
                        var c = a.indexOf("@");
        ...
        function tb(a) {
            var b = a.aoColumns, c = b.length, e = a.oFeatures, d = a.oPreviousSearch, f = a.aoPreSearchCols, g, i = [],
                j, n, l, q = T(a);
            g = a._iDisplayStart;
        ...
        function ob(a) {
            var b = a.oClasses, c = a.sTableId, e = a.oLanguage, d = a.oPreviousSearch, f = a.aanFeatures,
                g = '<input type="search" class="' + b.sFilterInput + '"/>', i = e.sSearch,
        ...
        function sb(a) {
            ...
            f.p || (b.id = a.sTableId +
                ...
                fn: function (a) {
                    if (e) {
                        var b = a._iDisplayStart, h = a._iDisplayLength, n = a.fnRecordsDisplay(), l = -1 === h,
                            b = l ? 0 : Math.ceil(b / h), h = l ? 1 : Math.ceil(n / h), n = c(b, h), q, l = 0;
        ...
        function qb(a) {
            ...
            var e = c.sX, d = c.sY, f = a.oClasses, g = b.children("caption"), i = g.length ? g[0]._captionSide : null,
                j = h(b[0].cloneNode(!1)), n = h(b[0].cloneNode(!1)), l = b.children("tfoot");
        ...
        function Y(a) {
            var b = a.oScroll, c = b.sX, e = b.sXInner, d = b.sY, f = b.iBarWidth, g = h(a.nScrollHead), i = g[0].style,
                j = g.children("div"), n = j[0].style, l = j.children("table"), j = a.nScrollBody, q = h(j),
                o = j.style, k = h(a.nScrollFoot).children("div"), p = k.children("table"), m = h(a.nTHead),
        ...
        function Ga(a) {
            var b = a.nTable, c = a.aoColumns, e = a.oScroll, d = e.sY, f = e.sX, g = e.sXInner, i = c.length,
                e = Z(a, "bVisible"), j = h("th", a.nTHead), n = b.getAttribute("width"), l = b.parentNode, k = !1, o,
                m;
            (o = b.style.width) &&
            -1 !== o.indexOf("%") && (n = o);
        ...
        m = function (a) {
            ...
            this.each(function () {
                var d = {}, d = 1 < e ? Lb(d, a, !0) : a, g = 0, i, j = this.getAttribute("id"), n = !1, l = m.defaults,
                    q = h(this);
        ...
        r("cells()", function (a, b, c) {
            ...
            if (null === b || b === k)return this.iterator("table",
                function (b) {
                    var d = a, e = ab(c), f = b.aoData, g = Ca(b, e), e = Sb(ia(f, g, "anCells")),
                        i = h([].concat.apply([], e)), j, l = b.aoColumns.length, n, m, r, t, s, u;
                    return $a(d, function (a) {
            ...
            function (a) {
                ...
                return this.iterator("table", function (b) {
                    var c = b.nTableWrapper.parentNode, e = b.oClasses, d = b.nTable, f = b.nTBody, g = b.nTHead,
                        i = b.nTFoot, j = h(d), f = h(f), k = h(b.nTableWrapper), l = h.map(b.aoData, function (a) {
                            return a.nTr
                        }), q;
                    b.bDestroying = !0;
        ...
        m.defaults = {
            ...
            oLanguage: {
                ...
                sSearchPlaceholder: "",
                sUrl: "",
                sZeroRecords: "رکوردی تشخیص داده نشد"
            },
